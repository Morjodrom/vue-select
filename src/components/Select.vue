	...
	export default {
		...
		methods: {
			...
			onAfterSelect(option) {
				...
				if(this.autocompleteMode){
					//this.search = option instanceof Object ? option[this.label] : option
				}
			...
			onSearchBlur() {
				...
				this.open = false
				this.$emit('search:blur', this.search)
			},
			...
			onSearchFocus() {
				...
				this.$emit('search:focus', newSearch => {
